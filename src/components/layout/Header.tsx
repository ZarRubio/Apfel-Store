...
export function Header() {
  ...
  return <header className="site-header" onKeyDown={(event) => {
    ...
    <div className="container nav-inner">
      <Link className="wordmark" href="/" aria-label="Apfel Store, inicio" onClick={() => setOpen(false)}><Image className="wordmark-mark" src="/images/brand/apfel-logo.jpg" alt="" width={38} height={38} /><span>Apfel <b>STORE</b></span></Link>
