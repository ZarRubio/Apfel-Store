...
export default async function ProductsPage() {
  ...
  return <main id="main-content" tabIndex={-1} className="catalog-page">
    ...
    <section className="catalog-launch container" aria-label="Nueva serie iPhone 18 Pro">
      ...
      <div className="catalog-launch-links"><Link href="/iphone/iphone-18-pro">Explorar Pro ↗</Link><Link href="/iphone/iphone-18-pro-max">Explorar Pro Max ↗</Link><Link href="/comparar">Comparar modelos ↗</Link></div>
    </section>
