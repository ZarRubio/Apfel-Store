...
export const metadata: Metadata = { title: { default: 'Apfel Store | Tu próximo iPhone', template: '%s | Apfel Store' }, description: 'Explora iPhones seleccionados, configura el tuyo y conversa por WhatsApp.', metadataBase: new URL(site.url), robots: { index: false, follow: false } };
